...
{{ include "ecr-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ecr-proxy.selectorLabels" -}}
...
{{- default (include "ecr-proxy.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "ecr-proxy.secretName" -}}
{{- if .Values.secret.create }}
{{- include "ecr-proxy.fullname" . }}
{{- else }}
